...
public class Board {
    ...
    public void update(int row, int col) {
        if(gameContinue){
            if(isBlack && !isWhite) {
                ...
                if (canPutPiece(newPiece.getRow(), newPiece.getCol(), 1)) {
                    board[newPiece.getRow()][ newPiece.getCol()].setValue(1);
                    checkBoard(1);
                }else System.out.println("black is fail");
                gameOn= BoardHelper.isGameFinished(board, 2);
                isWhite= true;
                isBlack= false;
                WhiteContinue=true;
            }
                ...
                gameOn= BoardHelper.isGameFinished(board, 1);
                isWhite= false;
                isBlack= true;
                WhiteContinue= false;
            }
    ...
    public void checkBoard(int value){
